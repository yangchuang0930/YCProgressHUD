...
-(void)btnTest:(UIButton *)sender{
    switch (sender.tag) {
        case 1001:{
            ...
            [YCProgressHUD showMessage:@"只显示文字" inView:self.view];
            break;
        }
        case 1002:{
            [YCProgressHUD showSuccess:@"加载成功" inview:self.view];
            break;
        }
        case 1003:{
            [YCProgressHUD showProgress:@"加载中..." inView:self.view];
            break;
        }
        case 1004:{
            [YCProgressHUD showMessage:@"请输入xxx" inView:self.view afterDelayTime:2.0];
            break;
        }
        case 1005:{
            [YCProgressHUD showMsgWithoutView:@"显示在最上层"];
            break;
        }
        default:
            break;
